...
** number. The column numbers are paired and specify ranges of colums from
...
int read_column_numbers(int columns[], int max)
{
  ...
  */
  ...
  /*
  **  Make sure we have an even number of inputs, as they are supposed to be
  ** paired.
  */
  if(num % 2 != 0)
  {
...
/*
**  Process a line of input by concatenating the characters
** from the indicated columns. The output line is then NUL
** terminated.
*/
   ...
   int n_columns, int const columns[])
{
  ...
  */
  ...
  for(col = 0; col < n_columns; col += 2)
  {
    ...
    /*
    ** If the input line isn't this long or the ouput
    ...
    */
    ...
    /*
    ** If there isn't room in the ouput array, only copy
    ** what will fit.
    */
